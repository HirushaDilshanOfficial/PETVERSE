...
const VetPackages = () => {
  ...
  const packages = [
    { name: "Basic", description: "Routine checkup and basic care." },
    { name: "Premium", description: "Includes vaccinations and health check." },
    { name: "Luxury", description: "Full care with lab tests, grooming, and wellness plan." },
  ];
  ...
  const downloadPDF = () => {
    ...
    doc.save("vet-appointment-details.pdf");
  };
