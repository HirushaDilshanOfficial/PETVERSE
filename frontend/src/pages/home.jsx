...
const Home = () => {
  ...
  const ads = [
    { id: 1, image: "/PA1.jpg", link: "/products" },
    { id: 2, image: "/PA2.jpg", link: "/grooming" },
    { id: 3, image: "/PA3.jpg", link: "/training" },
  ];
    ...
    <div className="bg-[#1C2A4A] min-h-screen font-sans text-gray-100 relative">
        ...
        <div className="grid gap-10 md:grid-cols-4 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="p-6 text-center flex-1">
              ...
              <p>
                Professional grooming services to keep your pets looking their
                best.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="p-6 text-center flex-1">
              ...
              <p>
                Effective training sessions for better behavior and obedience.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-6 bg-[#16203D] text-center">
        ...
        <p className="text-lg md:text-xl text-gray-300 mb-8">
          Explore our wide range of pet products and give your furry friend the
          best care!
        </p>
        <button
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="bg-[#1C2A4A] p-6 rounded-xl shadow-lg hover:scale-105 transition-transform">
            ...
            <p className="text-gray-300 mt-2">
              “Thanks to PetVerse’s veterinary care, Buddy recovered quickly
              from an illness.”
            </p>
      ...
      <section className="py-12 px-6 bg-[#0f172a] flex justify-center">
        <a href={ads[currentAd].link}>
          <img
            src={ads[currentAd].image}
            alt={`Advertisement ${ads[currentAd].id}`}
            className="w-[851px] h-[315px] object-cover rounded-xl shadow-lg hover:scale-105 transition-transform duration-500"
          />
        </a>
      </section>
      ...
      <footer className="bg-[#1E293B] text-gray-300 py-10 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
          <div>
            ...
            <p>
              Caring for your pets with love and professionalism. We provide
              grooming, boarding, training, and veterinary care.
            </p>
          </div>
          <div>
